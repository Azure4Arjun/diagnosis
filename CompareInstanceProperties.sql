----------------------------------------------------------------------------------
 ...
 --				Note that this script runs TRUNCATE TABLE if InstanceProperties already exists. So if you want long-term retention, you should remove that.
 ----------------------------------------------------------------------------------
...
GO
 GenerateInstancePropertiesForCompare.sql
 ----------------------------------------------------------------------------------
 -- Created: by Eitan Blumin 26/06/18
 --	Description:
 ...
 --				Requires high privliges on both servers.
 ----------------------------------------------------------------------------------
 SET NOCOUNT ON;
